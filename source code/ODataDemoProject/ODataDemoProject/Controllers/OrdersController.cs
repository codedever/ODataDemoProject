...
namespace ODataDemoProject.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [EnableQuery, HttpGet(nameof(GetOrders))]
        ...
        public IActionResult Seed()
        {
            if (!_context.Products.Any())
            {
                using (_context)
                {
                    ...
                    _context.AddToSaveChange(new OrderDetail { ProductId = mainBoard.Id, OrderId = mahuatengOrder1.Id, Count = 1, Description = "马化腾下的单", CreatedBy = userIdMahuateng, UpdatedBy = userIdMahuateng });
                    ...
                    _context.AddToSaveChange(new OrderDetail { ProductId = memory.Id, OrderId = mahuatengOrder2.Id, Count = 2, Description = "马化腾下的单", CreatedBy = userIdMahuateng, UpdatedBy = userIdMahuateng });
                    _context.AddToSaveChange(new OrderDetail { ProductId = ssd.Id, OrderId = mahuatengOrder2.Id, Count = 5, Description = "马化腾下的单", CreatedBy = userIdMahuateng, UpdatedBy = userIdMahuateng });
                    ...
                    _context.UpdateToSaveChange(computer.Id, computer);
                }
            }
